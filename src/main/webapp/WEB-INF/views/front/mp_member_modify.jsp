							...
							<form role="form" action="/mypage/mp_member_modify"
								...
								<tbody>
									...
									<tr>
										...
										<td><c:out value="${member_info.userid }" />
										<input type="hidden" name=userid value="${member_info.userid }"> </td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><input type="text" name="other_address" value=""></td>
									</tr>
									<tr>
										<th scope="col">SNS주소</th>
										<td><input type="text" name="sns" value=""></td>
									</tr>
									<tr>
