...
<body>
  ...
  <div class="wrapper">
    <jsp:include page="/WEB-INF/views/include/side_bar-admin.jsp"></jsp:include>
      ...
      <table class="table">
        <tbody>
          ...
          <tr>
            ...
            <td colspan="3"><input type="text" name="birth" placeholder="20991231"/></td>
          </tr>
          <tr>
            <td width="150px">휴대폰번호</td>
            <td colspan="3"><input type="text" name="phone" placeholder="01012345678"/></td>
          </tr>
          <tr>
      ...
      <div align="center">
      <input type="button" class="snip1535" name="submit" value="수정"/>
